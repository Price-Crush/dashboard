                            ...
                            <table class="table" id="data-table">
                                ...
                                <tbody>
                                    @foreach ($cities as $key => $city)
                                        <tr>
                                            <td>{{ $city->id }}</td>
                                            <td>{{ $city->state->name_en }}</td>
                                            <td>{{ $city->name_ar }}</td>
                                            <td>{{ $city->name_en }}</td>
                                            <td>{{ $city->name_tr }}</td>
                                            <td>{{ $city->price }} </td>
                                            <td>{{ $city->user_banner_price }} </td>
                                            <td>
                                                <button class="btn btn-success" name="edit_button"
                                                    value="{{ $city->id }}" data-toggle="modal" onclick="get_details(this)"
        ...
        <div class="modal-dialog modal-dialog-scrollable" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form class="form form-vertical" action="/admin-panel/cities" method="POST"
