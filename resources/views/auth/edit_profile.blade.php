                                ...
                                <div class="tab-content">
                                    <div class="tab-pane active" id="tabVerticalLeft1" role="tabpanel"
                                        ...
                                        <div class="container">
                                            ...
                                            @endif
                                            <form class="form form-vertical" action="/admin-panel/update_profile" method="POST"
                                    ...
                                    <div class="tab-pane" id="tabVerticalLeft2" role="tabpanel"
                                        ...
                                        <div class="container">
                                            ...
                                            @endif
                                            <form class="form form-vertical" action="/admin-panel/update_password" method="POST"
                                                enctype="multipart/form-data">
                                                @csrf
                                                <div class="form-body">
                                                    <div class="row">
