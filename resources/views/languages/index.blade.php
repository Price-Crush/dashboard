                            ...
                            <table class="table zero-configuration">
                                ...
                                <tbody>
                                    @foreach ($languages as $key => $language)
                                        <tr>
                                            <td>{{ ++$key }}</td>
                                            <td>{{ $language->language_name_ar }}</td>
                                            <td>{{ $language->language_name_en }}</td>
                                            <td>{{ $language->language_name_tr }}</td>
                                            <td>{{ $language->language_code }}</td>

                                            <td>
                                                <button class="btn btn-success" name="edit_button"
                                                    value="{{ $language->id }}" data-toggle="modal"
        ...
        <div class="modal-dialog modal-dialog-scrollable" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form class="form form-vertical" action="/admin-panel/languages" method="POST"
                                ...
                                <div class="col-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control @error('language_name_ar') is-invalid @enderror"
                                            name="language_name_ar" placeholder="Language Name AR" value="{{ old('language_name_ar') }}" required>
                                    </div>
                                </div>
                                <div class="col-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control @error('language_name_en') is-invalid @enderror"
                                            name="language_name_en" placeholder="Language Name EN" value="{{ old('language_name_en') }}" required>
                                    </div>
                                </div>
                                <div class="col-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control @error('language_name_tr') is-invalid @enderror"
                                            name="language_name_tr" placeholder="Language Name TR" value="{{ old('language_name_tr') }}" required>
                                    </div>
                                </div>
                                <div class="col-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control @error('language_code') is-invalid @enderror"
                                            name="language_code" placeholder="Language Code" value="{{ old('language_code') }}" required>
                                    </div>
                                </div>
                                <div class="col-12">
...
@section('scriptjs')
    <script>
        function get_details(val) {
            ...
            $.get("/admin-panel/languages/" + edit_val + "/edit", function(data, status) {
